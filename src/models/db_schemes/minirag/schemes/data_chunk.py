...
class DataChunk(SQLAlchemyBase):
    ...
    chunk_id = Column(type_=Integer, primary_key=True, autoincrement=True)
    ...
    # asset وتبع اي project دي تبع اي datachunk عشان احدد ال relation محتاج بقي اني اعمل 
...
# vector databaseدي عشان النتايج الي هتجي من ال 
